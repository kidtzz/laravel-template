    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-laravel" aria-expanded="true">
          <span>
            ...
            <span class="sidebar-text" style="color: #fb503b;">Configure</span>
          </span>
      ...
      <li class="nav-item">
        <a href="" class="nav-link d-flex justify-content-between">
          ...
          <span>
            <span class="badge badge-sm bg-success ms-1">Prondol</span>
          </span>
        </a>
      </li>
      <li class="nav-item">
        <a href="" class="nav-link d-flex justify-content-between">
          ...
          <span>
            <span class="badge badge-sm bg-warning ms-1">Cok</span>
          </span>
        </a>
      </li>
      <li class="nav-item">
        <span class="nav-link {{ Request::segment(1) !== 'bootstrap-tables' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-app">
          <span>
            <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'bootstrap-tables' ? 'show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
          <ul class="flex-column nav">
...
<!-- /documentation/getting-started/overview/index.html -->